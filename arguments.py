...
def add_model_config_args(parser):
    ...
    group.add_argument('--extra-token', type=str, default="")
    ...
    group.add_argument('--facet2facet_mr', action='store_true', help='use facet to facet loss')
    group.add_argument('--alter_point', type=int, default=-1)
    ...
    group.add_argument('--use_proj_bias', action='store_true', help='whether we use bias in BertHeadTransform')
    group.add_argument('--use-multitasks', action='store_true', help='make each facet handle a task')
    group.add_argument('--bi_head', action='store_true', help='')
    group.add_argument('--loss_mode', type=str, default="log", help='could be log or weighted')
    group.add_argument('--same_out', action='store_true', help='')
    group.add_argument('--diversify_hidden_layer', type=str, default="")
    group.add_argument('--diversify_mode', type=str, default="pos+lin")
    #group.add_argument('--use_hard_neg', action='store_true', help='')
    group.add_argument('--use_hard_neg', type=int, default=0, help='')
    group.add_argument('--same-weight-internal', action='store_true', help='initialize same weights for internal diversification embeddings')
    group.add_argument('--skip_act', action='store_true', help='')
    group.add_argument('--minus_avg_div', action='store_true', help='')
    group.add_argument('--testing_agg', action='store_true', help='')
    group.add_argument('--add_testing_agg', action='store_true', help='')
    group.add_argument('--agg_weight', type=float, default=0.5, help='')
    group.add_argument('--so_sharing', action='store_true', help='')
    group.add_argument('--post_normalization', action='store_true', help='')
    group.add_argument('--facet_mode', type=str, default="")
    group.add_argument('--tot_tokens', type=int, default=0, help='used in the continual training')
    group.add_argument('--facet_mask', type=float, default=0.0, help='negative value to mask facet attention ')
...
def add_training_args(parser):
    ...
    group.add_argument('--save_suffix', type=str, default=None,
                       help='Output directory suffix to save checkpoints to.')
...
def add_data_args(parser):
    ...
    group.add_argument('--num-workers', type=int, default=12,
...
def get_args():
    ...
    if 'mf' in args.modes:
        ...
        pretrained_path=pretrained_path+'_'+args.agg_function+'_'+args.extra_token+'_'+args.save_suffix
        if args.dot:
            pretrained_path=pretrained_path+'_'+'dot'
    
    if args.save is None:
        #args.save = os.path.join(pretrained_path, args.model_type)
        args.save = os.path.join(pretrained_path, 'mf+mlm')
